...
public class GuardianStoneRenderer extends TileEntitySpecialRenderer {
	...
	private void drawCore() {
		ReikaTextureHelper.bindTerrainTexture();
		Block b = GeoBlocks.CRYSTAL.getBlockInstance();
		Icon ico = b.getIcon(0, 0);
		float u = ico.getMinU();
		float v = ico.getMinV();
		float du = ico.getMaxU();
		float dv = ico.getMaxV();
