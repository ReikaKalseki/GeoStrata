...
public class CrystalBees {
	...
	public static class FlowerProviderCrystal implements IFlowerProvider {
		...
		public boolean isAcceptedFlower(World world, IIndividual individual, int x, int y, int z) {
			return world.getBlockId(x, y, z) == GeoBlocks.CRYSTAL.getBlockID() && world.getBlockMetadata(x, y, z) == dye.ordinal();
		}
		...
		public ItemStack[] getItemStacks() {
			return new ItemStack[]{new ItemStack(GeoBlocks.CRYSTAL.getBlockID(), 1, dye.ordinal())};
		}
